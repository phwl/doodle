...
gen_paper_data.py        regenerates every number/table/figure in the paper
paper/paper.tex          the architecture paper (pdflatex paper.tex, twice)
...
python gen_paper_data.py     # regenerate paper/generated/*
