...
-- Date        : Mon Apr 27 18:10:16 2026
-- Host        : tp-p14s running 64-bit Ubuntu 24.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/work/acin/projects/universal_lqg/lqg-fp7-firmware/src/bds/design_0_rpgen2/ip/design_0_axis_red_pitaya_dac_0_0/design_0_axis_red_pitaya_dac_0_0_sim_netlist.vhdl
...
entity design_0_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac is
  port (
  ...
  attribute ORIG_REF_NAME of design_0_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac : entity is "axis_red_pitaya_dac";
end design_0_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac;

architecture STRUCTURE of design_0_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac is
...
entity design_0_axis_red_pitaya_dac_0_0 is
  ...
  attribute NotValidForBitStream of design_0_axis_red_pitaya_dac_0_0 : entity is true;
  ...
  attribute X_CORE_INFO of design_0_axis_red_pitaya_dac_0_0 : entity is "axis_red_pitaya_dac,Vivado 2024.2";
end design_0_axis_red_pitaya_dac_0_0;

architecture STRUCTURE of design_0_axis_red_pitaya_dac_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF s_axis, FREQ_HZ 15625000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /ADC_subsys/clk_wiz_0_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s_axis_tready : signal is "XIL_INTERFACENAME s_axis, FREQ_HZ 15625000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, PHASE 0.0, CLK_DOMAIN /ADC_subsys/clk_wiz_0_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
...
inst: entity work.design_0_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac
     port map (
      aclk => aclk,
      dac_clk => dac_clk,
