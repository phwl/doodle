...
//PORTS
      ...
      bit  [3 : 0] S_AXI_HP0_BID;
      bit  [3 : 0] S_AXI_HP0_RID;
      ...
      bit  [3 : 0] S_AXI_HP0_ARID;
      bit  [3 : 0] S_AXI_HP0_AWID;
      bit  [3 : 0] S_AXI_HP0_WID;
      ...
      bit  [3 : 0] S_AXI_HP1_BID;
      bit  [3 : 0] S_AXI_HP1_RID;
      ...
      bit  [3 : 0] S_AXI_HP1_ARID;
      bit  [3 : 0] S_AXI_HP1_AWID;
      bit  [3 : 0] S_AXI_HP1_WID;
...
//PARAMETERS
      ...
      parameter C_S_AXI_HP0_ID_WIDTH = 4;
      parameter C_S_AXI_HP0_DATA_WIDTH = 64;
      parameter C_S_AXI_HP1_ID_WIDTH = 4;
...
//REG DECLARATIONS
      ...
      reg [3 : 0] S_AXI_HP0_BID;
      reg [3 : 0] S_AXI_HP0_RID;
