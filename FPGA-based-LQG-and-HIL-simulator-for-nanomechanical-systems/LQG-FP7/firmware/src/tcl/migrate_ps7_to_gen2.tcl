# ------------------------------------------------------------------------------
#  WARNING: Do not run this script without backup!
#  This script is intended to migrate a PS7-based block design to match the
#  configuration of the Gen2 RedPitaya PS7 block.
# ------------------------------------------------------------------------------

# Path to the PS7 processing system block in the block design.
set ps7_path "PS7_w_DMA_subsys/PS7_subsys/processing_system7"
...
set processing_system7 [ get_bd_cells $ps7_path ]

# These are the settings taken from the Gen2 RedPitaya PS7 configuration.
# May need to be adapted depending on the specific implementation; make sure
# to back up the original design before running this script!
