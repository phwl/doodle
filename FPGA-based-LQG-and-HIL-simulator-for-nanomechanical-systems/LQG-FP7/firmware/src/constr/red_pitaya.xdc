...
# ADC data
set_property IOSTANDARD LVCMOS18 [get_ports {adc_dat_i_a[*]}]
set_property IOB        TRUE     [get_ports {adc_dat_i_a[*]}]
set_property IOSTANDARD LVCMOS18 [get_ports {adc_dat_i_b[*]}]
set_property IOB        TRUE     [get_ports {adc_dat_i_b[*]}]

# ADC 0 data
set_property PACKAGE_PIN V17     [get_ports {adc_dat_i_a[0]}]
set_property PACKAGE_PIN U17     [get_ports {adc_dat_i_a[1]}]
set_property PACKAGE_PIN Y17     [get_ports {adc_dat_i_a[2]}]
set_property PACKAGE_PIN W16     [get_ports {adc_dat_i_a[3]}]
set_property PACKAGE_PIN Y16     [get_ports {adc_dat_i_a[4]}]
set_property PACKAGE_PIN W15     [get_ports {adc_dat_i_a[5]}]
set_property PACKAGE_PIN W14     [get_ports {adc_dat_i_a[6]}]
set_property PACKAGE_PIN Y14     [get_ports {adc_dat_i_a[7]}]
set_property PACKAGE_PIN W13     [get_ports {adc_dat_i_a[8]}]
set_property PACKAGE_PIN V12     [get_ports {adc_dat_i_a[9]}]
set_property PACKAGE_PIN V13     [get_ports {adc_dat_i_a[10]}]
set_property PACKAGE_PIN T14     [get_ports {adc_dat_i_a[11]}]
set_property PACKAGE_PIN T15     [get_ports {adc_dat_i_a[12]}]
set_property PACKAGE_PIN V15     [get_ports {adc_dat_i_a[13]}]
set_property PACKAGE_PIN T16     [get_ports {adc_dat_i_a[14]}]
set_property PACKAGE_PIN V16     [get_ports {adc_dat_i_a[15]}]

# ADC 1 data
set_property PACKAGE_PIN T17     [get_ports {adc_dat_i_b[0]}]
set_property PACKAGE_PIN R16     [get_ports {adc_dat_i_b[1]}]
set_property PACKAGE_PIN R18     [get_ports {adc_dat_i_b[2]}]
set_property PACKAGE_PIN P16     [get_ports {adc_dat_i_b[3]}]
set_property PACKAGE_PIN P18     [get_ports {adc_dat_i_b[4]}]
set_property PACKAGE_PIN N17     [get_ports {adc_dat_i_b[5]}]
set_property PACKAGE_PIN R19     [get_ports {adc_dat_i_b[6]}]
set_property PACKAGE_PIN T20     [get_ports {adc_dat_i_b[7]}]
set_property PACKAGE_PIN T19     [get_ports {adc_dat_i_b[8]}]
set_property PACKAGE_PIN U20     [get_ports {adc_dat_i_b[9]}]
set_property PACKAGE_PIN V20     [get_ports {adc_dat_i_b[10]}]
set_property PACKAGE_PIN W20     [get_ports {adc_dat_i_b[11]}]
set_property PACKAGE_PIN W19     [get_ports {adc_dat_i_b[12]}]
set_property PACKAGE_PIN Y19     [get_ports {adc_dat_i_b[13]}]
set_property PACKAGE_PIN W18     [get_ports {adc_dat_i_b[14]}]
set_property PACKAGE_PIN Y18     [get_ports {adc_dat_i_b[15]}]

set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports adc_clk_i_a]
set_property PACKAGE_PIN U18           [get_ports adc_clk_i_a]
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports adc_clk_i_b]
set_property PACKAGE_PIN U19           [get_ports adc_clk_i_b]
...
create_clock -period 8.000 -name adc_clk [get_ports adc_clk_i_a]

set_input_delay -clock adc_clk -max 3.400 [get_ports adc_dat_i_a[*]]
set_input_delay -clock adc_clk -max 3.400 [get_ports adc_dat_i_b[*]]
