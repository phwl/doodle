...
# ******************************************************************************
#  This file was used to generate the initial version of the lqg_fp7_rpgen2
#  design. DO NOT regenerate the design using this, this project is using the
#  XPR as the source of truth!
# ******************************************************************************
...
if { $list_projs eq "" } {
   create_project lqg_fp7_rpgen2 lqg_fp7_rpgen2 -part xc7z020clg400-1
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name lqg_fp7_rpgen2
