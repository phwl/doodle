        ...
        if (rst) begin
            ...
            case (state)
                ...
                READ: begin
                    ...
                    cfg_ram_addr <= cfg_ram_addr + 1;

                    word_valid <= {word_valid[BRAM_READ_LATENCY-2:0], 1'b1};
                ...
                WAIT: begin
                    ...
                    word_valid <= {word_valid[BRAM_READ_LATENCY-2:0], 1'b0};
