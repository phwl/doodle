...
-- Date        : Mon May  4 12:18:52 2026
-- Host        : tp-p14s running 64-bit Ubuntu 24.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/work/acin/projects/redpitaya-hil-simulator/ipcore/bds/design_0_rpgen2/ip/design_0_axis_red_pitaya_adc_1_0/design_0_axis_red_pitaya_adc_1_0_sim_netlist.vhdl
...
entity design_0_axis_red_pitaya_adc_1_0_axis_red_pitaya_adc is
  port (
  ...
  attribute ORIG_REF_NAME of design_0_axis_red_pitaya_adc_1_0_axis_red_pitaya_adc : entity is "axis_red_pitaya_adc";
end design_0_axis_red_pitaya_adc_1_0_axis_red_pitaya_adc;

architecture STRUCTURE of design_0_axis_red_pitaya_adc_1_0_axis_red_pitaya_adc is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_0_axis_red_pitaya_adc_1_0 is
  port (
    adc_clk : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_0_axis_red_pitaya_adc_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_0_axis_red_pitaya_adc_1_0 : entity is "design_0_axis_red_pitaya_adc_1_0,axis_red_pitaya_adc,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_0_axis_red_pitaya_adc_1_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of design_0_axis_red_pitaya_adc_1_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_0_axis_red_pitaya_adc_1_0 : entity is "axis_red_pitaya_adc,Vivado 2024.2";
end design_0_axis_red_pitaya_adc_1_0;

architecture STRUCTURE of design_0_axis_red_pitaya_adc_1_0 is
  ...
  attribute X_INTERFACE_PARAMETER of adc_clk : signal is "XIL_INTERFACENAME adc_clk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_0_axis_red_pitaya_adc_1_0_adc_clk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tvalid : signal is "XIL_INTERFACENAME m_axis, FREQ_HZ 125000000, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
...
inst: entity work.design_0_axis_red_pitaya_adc_1_0_axis_red_pitaya_adc
     port map (
      adc_clk => adc_clk,
      adc_clk_n => adc_clk_n,
      adc_clk_p => adc_clk_p,
