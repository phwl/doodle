...
//               /home/user/work/acin/projects/redpitaya-hil-simulator/ipcore/bds/design_0_rpgen2/ip/design_0_axis_red_pitaya_adc_1_0/design_0_axis_red_pitaya_adc_1_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_0_axis_red_pitaya_adc_1_0,axis_red_pitaya_adc,{}" *) (* CORE_GENERATION_INFO = "design_0_axis_red_pitaya_adc_1_0,axis_red_pitaya_adc,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=axis_red_pitaya_adc,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,ADC_DATA_WIDTH=14,AXIS_TDATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "axis_red_pitaya_adc,Vivado 2024.2" *) 
module design_0_axis_red_pitaya_adc_1_0(adc_clk, adc_csn, adc_clk_p, adc_clk_n, 
...
/* synthesis syn_force_seq_prim="adc_clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 adc_clk CLK" *) (* X_INTERFACE_MODE = "master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME adc_clk, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_0_axis_red_pitaya_adc_1_0_adc_clk, INSERT_VIP 0" *) output adc_clk /* synthesis syn_isclock = 1 */;
  output adc_csn;
